...
[frontend-architecture](../architecture/frontend-architecture.md)、[exploration-api 计划](2026-08-arch019-exploration-api.md)（消费契约）
...
[exploration-api 计划](2026-08-arch019-exploration-api.md) 契约冻结；QED-Tracker 端点就绪前
以 mock 数据开发界面（不阻塞并行）。
