...
关联设计：[backend-domain-split.md](../../../architecture/backend-architecture.md)（三域已实施）、
[../architecture/api-contracts.md](../../../architecture/api-contracts.md)、[service-control.md](../../../design/service-hosting.md)、
[service-contracts.md](../../../design/cross-project-contracts.md)、[dataset-conventions.md](../../../design/dataset-conventions.md)、
