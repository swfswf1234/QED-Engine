...
> 实现细节以当前代码与 [configuration-and-secrets.md](../../../design/project-configuration.md) 为准。
...
关联设计：[llm-gateway-and-model-management.md](../../../design/llm-gateway.md)（Accepted）、
[configuration-and-secrets.md](../../../design/project-configuration.md)（密钥分置修订）、
