...
关联设计：[服务契约](../../../design/cross-project-contracts.md)、[dataset 目录约定](../../../design/dataset-conventions.md)、[统一配置与密钥规范](../../../design/project-configuration.md)、[配置中心 API 契约](../../../architecture/api-contracts.md)
