...
| `guides/` | 人类可读的**操作文档**与**开发文档**（介绍项目怎么开发、怎么运维），可包含架构信息；为人类设计，由人类判断何时整理，agent 开发时不主动涉及。例外（ADR 0012）：`development.md` 的「AI 开发工作流程」节由人类授权承载 agent 开发流程细则。 |
...
工作流程细则见 [开发指南·AI 开发工作流程](../guides/development.md)；standards 实质规则
变更仍按「变更与取代」节先立 ADR。
